...
function renderDailySchedule() {
  ...
  for (const [dateString, dailySlots] of Object.entries(liveDailyCache)) {
      ...
      if (comment) {
          ...
          dailyHtml += `<div style="font-size:12px; font-weight:700; color:${badgeColor}; margin-bottom:8px; background:${badgeBg}; padding:8px 12px; border-radius:6px; border:1px solid ${badgeBorder}; display:flex; align-items:center; gap:8px;">
